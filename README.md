...
```
wget --no-check-certificate -qO natcfg.sh https://raw.githubusercontent.com/Howardnm/iptablesUtils/master/natcfg.sh && bash natcfg.sh
```
...
```shell
wget --no-check-certificate -qO uninstall.sh https://raw.githubusercontent.com/Howardnm/iptablesUtils/master/dnat-uninstall.sh && bash uninstall.sh
```
